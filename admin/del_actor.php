...
if ($HTTP_POST_VARS['id']) {
  ...
  $result=mysql_query("SELECT name FROM ".$db_prefix."actor WHERE id=".$var['id'].";");
  $cad=mysql_fetch_array ($result);
  mysql_free_result($result);
  $sql="DELETE FROM ".$db_prefix."actor WHERE id='".$var['id']."';";
  ...
  print "<html><body>\n";
  print "<center><h1>$d_actor</h1><form action=\"del_actor.php\" method=\"post\">\n";
