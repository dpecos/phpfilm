...
print "<br><br>\n";
print "<h3><font color=\"".$title_color."\">".$t_director_films."</font></h3><br>\n";
$query="SELECT f.* FROM ".$db_prefix."film f,".$db_prefix."director_film df WHERE df.director_id=".$var['director_id']." and f.id=df.film_id ORDER BY f.title;"; 
show_index($query);
