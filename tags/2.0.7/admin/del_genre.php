...
if ($HTTP_POST_VARS['id']) {
  ...
  $result=mysql_query("SELECT name FROM ".$db_prefix."genre WHERE id=".$var['id']);
  $cad=mysql_fetch_array($result);
  mysql_free_result($result);
  $sql="DELETE FROM ".$db_prefix."genre WHERE id='".$var['id']."';";
  mysql_query($sql);
  print $correct." (".$cad[0].")\n";
  ...
  print "<html><body>\n";
  print "<center><h1>$d_genre</h1><form action=\"del_genre.php\" method=\"post\">\n";
